...
/// <summary>
/// Converts SQL Server <c>FOR JSON</c> output to plain CLR values for the provider-neutral
/// wire types, mirroring the Mongo/Postgres providers: numbers arrive as <see cref="long"/>
/// when they fit and <see cref="double"/> otherwise, so client-side numeric assertions and the
/// <c>ObjectToInferredTypesConverter</c> agree.
/// </summary>
